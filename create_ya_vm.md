...
yc compute instance get wb-pg
yc compute instance get --full wb-pg
```
...
## Удаление ВМ
```bash
# yc compute instance stop wb-pg
# yc compute instance start wb-pg
# yc compute instance restart wb-pg
yc compute instance delete wb-pg
```
